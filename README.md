...
| 이름             | 별명        | 역할         | 사진             | 담당 기능      |
|------------------|-------------|--------------|------------------|----------------|
| 어수현 (BE, 팀장) | 별명        | Backend      | ![사진](사진링크) | 기능1, 기능2    |
| 이정원 (FE, 팀장) | 별명        | Frontend     | ![사진](사진링크) | 기능3, 기능4    |
| 김형일 (FE)      | 별명        | Frontend     | ![사진](사진링크) | 기능5, 기능6    |
| 안형준 (BE)      | 별명        | Backend      | ![사진](사진링크) | 기능7, 기능8    |
| 김종현 (FE)      | 별명        | Frontend     | ![사진](사진링크) | 기능9, 기능10   |
| 김휴 (BE)        | 별명        | Backend      | ![사진](사진링크) | 기능11, 기능12  |
| 이하루 (BE)      | 별명        | Backend      | ![사진](사진링크) | 기능13, 기능14  |
