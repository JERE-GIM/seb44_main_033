...
| 이름 | 별명 | 역할 | 사진 | 담당 기능 |
| :---: | :---: | :---: | :---: | :---: |
| 어수현<br>(BE, 팀장) | 수현프린세스 | Backend |<img src="https://github.com/codestates-seb/seb44_main_033/assets/124702162/05d079a2-74b4-4bac-9aaa-65a95ab0817f" height="130" width="100"> | 멤버쉽 CRUD<br> 영화 찜 목록 CRUD<br> 이미지 업로드<br> Spring Security<br> JWT 로그인<br> OAuth2 로그인<br> CI/CD(Github Actions, AWS S3, AWS CodeDeploy, AWS EC2)<br> AWS RDS 구축    |
| 이정원<br>(FE, 팀장) | 정원곤듀        | Frontend     | ![사진](사진링크) | 기능3, 기능4    |
| 김형일<br>(FE)      | 형일겅듀        | Frontend     | ![사진](사진링크) | 기능5, 기능6    |
| 안형준<br>(BE)      | 형준공쥬        | Backend      | ![사진](사진링크) | 기능7, 기능8    |
| 김종현<br>(FE)      | 종현공듀        | Frontend     | ![사진](사진링크) | 기능9, 기능10   |
| 김휴<br>(BE)        | 휴공주        | Backend      | ![사진](사진링크) | 기능11, 기능12  |
| 이하루<br>(BE)      | 하루히메사마        | Backend      | ![사진](사진링크) | 기능13, 기능14  |
