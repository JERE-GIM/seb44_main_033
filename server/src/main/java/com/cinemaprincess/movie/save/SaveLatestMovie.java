...
@Slf4j
@Transactional
public class SaveLatestMovie extends SaveMovieList {
    public SaveLatestMovie(MovieJdbcRepository movieJdbcRepository, SaveMovieDetail saveMovieDetail, RestTemplateConfig restTemplateConfig) {
