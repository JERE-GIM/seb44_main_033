...
public class SaveMovieDetail {
    ...
    public String buildMovieListUrl(long movieId, String language) {
    ...
    public MovieDetail getMovieDetail(long movieId) {
        ...
        try {
            String url = buildMovieListUrl(movieId, "ko");
            ...
            if (movieDetail != null && movieDetail.getOverview().isEmpty()) { // 한글 개요가 없을때 영어 개요 가져오기
                url = buildMovieListUrl(movieId, "en");
    ...
    public String parseOverview(String responseBody) {
        JsonParser jsonParser = new JsonParser();
        JsonObject jsonObject = jsonParser.parse(responseBody).getAsJsonObject();
        return jsonObject.get("overview").getAsString();
    }

    public MovieDetail parseMovieDetail(String responseBody) {
        JsonParser jsonParser = new JsonParser();
        JsonObject jsonObject = jsonParser.parse(responseBody).getAsJsonObject();
